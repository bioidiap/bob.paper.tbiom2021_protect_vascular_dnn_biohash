""" Configuration for BioHashing fingervein features extracted using the Wide Line Detector feature extractor, for the VERA Finger Vein database """ 
...
sub_directory = 'wld-BHsh-100-stolen/baseline'  # pre-processed and extracted features will be placed here, along with the enrolled models
