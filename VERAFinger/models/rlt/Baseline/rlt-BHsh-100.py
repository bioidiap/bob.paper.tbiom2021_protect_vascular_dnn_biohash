""" Configuration for extracting fingervein features using the RLT feature extractor and calculating the baseline match scores, for the VERA Finger Vein database """ 
...
sub_directory = 'rlt-BHsh-100/baseline'  # pre-processed and extracted features will be placed here, along with the enrolled models
