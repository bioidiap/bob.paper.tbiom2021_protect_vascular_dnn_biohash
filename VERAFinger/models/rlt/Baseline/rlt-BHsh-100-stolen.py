""" Configuration for BioHashing fingervein features extracted using the RLT feature extractor, for the VERA Finger Vein database """ 
...
sub_directory = 'rlt-BHsh-100-stolen/baseline'  # pre-processed and extracted features will be placed here, along with the enrolled models
