...
all_feats = np.load('../../../../../data/all_mc_aug_feats.npy')
...
all_input = np.zeros([all_feats.shape[0], all_feats.shape[1], all_feats.shape[2]-14, all_feats.shape[3]-13])
all_input[:,:,:,:] = all_feats[:,:,7:-7,7:-6]#/255.
