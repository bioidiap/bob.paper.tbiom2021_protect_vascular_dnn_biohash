...
all_input = np.zeros([all_feats.shape[0], all_feats.shape[1], all_feats.shape[2]-4, all_feats.shape[3]-3])
all_input[:,:,:,:] = all_feats[:,:,2:-2,2:-1]#/255.
