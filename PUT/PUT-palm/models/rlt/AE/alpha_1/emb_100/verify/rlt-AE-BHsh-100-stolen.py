...
sub_directory = 'rlt-AE-BHsh-100-stolen/baseline'  # pre-processed and extracted features will be placed here, along with the enrolled models
...
class RepeatedLineTracking (Extractor):
    ...
    def __call__(self, image):
        ...
        img_veins_bin=np.zeros([1,1,rlt.shape[0]-12,rlt.shape[1]+7])
        img_veins_bin[0,0,:,3:-4] = rlt[6:-6,:]#/255.
