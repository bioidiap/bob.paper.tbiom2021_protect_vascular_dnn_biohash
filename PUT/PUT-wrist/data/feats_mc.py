...
# all_feats_rlt=[]
# all_imgs_prep=[]
all_imgs_aug = np.load('wrist_all_imgs_aug.npy') 

print("preparing data")
mylog_csv_path="my_log_mc"
...
# np.save('wrist_all_wld_aug_feats.npy', all_feats_wld) 
np.save('wrist_all_mc_aug_feats.npy', all_feats_mc) 
# np.save('wrist_all_rlt_aug_feats.npy', all_feats_rlt) 
# np.save('wrist_all_imgs_aug_prep.npy', all_imgs_prep) 
