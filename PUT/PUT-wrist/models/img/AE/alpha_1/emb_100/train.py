...
all_feats = np.load('../../../../../data/wrist_all_imgs_aug_prep.npy')
...
#394, 522 -> (384,512)
all_input = np.zeros([all_feats.shape[0], all_feats.shape[1], all_feats.shape[2]-10, all_feats.shape[3]-10])
all_input[:,:,:,:] = all_feats[:,:,5:-5,5:-5]/255.
