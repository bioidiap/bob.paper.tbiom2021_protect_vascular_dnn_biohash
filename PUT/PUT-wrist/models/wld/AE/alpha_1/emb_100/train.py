...
all_feats = np.load('../../../../../data/wrist_all_wld_aug_feats.npy')
...
#50, 65 -> (64,64)
all_input = np.zeros([all_feats.shape[0], all_feats.shape[1], all_feats.shape[2]+1, all_feats.shape[3]+3])
all_input[:,:,:-1,1:-2] = all_feats[:,:,:,:]#/255.
