""" Configuration for BioHashing fingervein features extracted using the deep neural network (Auto-encoder), for the UTFVP database """ 
...
from bob.bio.vein.preprocessor import NoCrop, NoMask, NoNormalization, \
