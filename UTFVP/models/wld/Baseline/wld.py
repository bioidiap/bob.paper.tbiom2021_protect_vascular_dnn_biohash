""" Configuration for extracting fingervein features using the Wide Line Detector feature extractor and calculating the baseline match scores, for the UTFVP database """ 
