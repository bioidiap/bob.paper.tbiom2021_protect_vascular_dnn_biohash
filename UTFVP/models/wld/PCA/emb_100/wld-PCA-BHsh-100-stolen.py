...
sub_directory = 'wld-PCA-BHsh-100-stolen/baseline'  # pre-processed and extracted features will be placed here, along with the enrolled models
...
class WideLineDetector (Extractor):
    ...
    def wide_line_detector(self, finger_image, mask):
        ...
        img_veins_bin_=np.reshape(img_veins_bin,(1,-1))
        
        img_veins_bin_ = pca_model.transform(img_veins_bin_)
        
        return img_veins_bin_
